"""
Sample using atheris to find bugs in a function via fuzzing. This example shows how to use atheris on a function with
multiple input parameters of different types. The function (under test) signature will be used to determine
how to transform the generated bytes from atheris to the right types.

- int_and_str_func is the function being tested
...
if __name__ == "__main__":
    # todo - can sys.argv be used to indicate which function to test? could test that input is importable
